...
class Overlays {
  ...
  getTokenOverlay(BuildContext screenContext) {
              ...
              Material(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Preencha com o token fornecido pelo cliente!",
                        style: textFamily(
                          context,
                          fontSize: 16,
  ...
  insertToastOverlay(String title, {Color? color}) {
        ...
        return Positioned(
          ...
          child: Observer(
            builder: (observerContext) {
              print(
                  'observer addressStore.addressOverlay: ${addressStore.addressOverlay}');
